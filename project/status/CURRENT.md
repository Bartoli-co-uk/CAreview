...
| Next permitted action | Launch `./scripts/run-codex-review.sh issue ISSUE-0017 4812954 <HEAD-SHA>` and present the outcome. `ISSUE-0018` remains unauthorized to start |
