...
`ISSUE-0017` is `IN PROGRESS` (started `DECISION-041`), round 0 candidate
committed, awaiting Codex issue review. `ISSUE-0018` is not yet authorized
to start.
